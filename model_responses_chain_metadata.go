...
// checks if the ResponsesChainMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponsesChainMetadata{}

// ResponsesChainMetadata struct for ResponsesChainMetadata
type ResponsesChainMetadata struct {
...
func (o ResponsesChainMetadata) MarshalJSON() ([]byte, error) {
...
func (o ResponsesChainMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableResponsesChainMetadata struct {
	value *ResponsesChainMetadata
	isSet bool
}

func (v NullableResponsesChainMetadata) Get() *ResponsesChainMetadata {
	return v.value
}

func (v *NullableResponsesChainMetadata) Set(val *ResponsesChainMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableResponsesChainMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableResponsesChainMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponsesChainMetadata(val *ResponsesChainMetadata) *NullableResponsesChainMetadata {
	return &NullableResponsesChainMetadata{value: val, isSet: true}
}

func (v NullableResponsesChainMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponsesChainMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
