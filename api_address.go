...
type ApiAddressBalancesRequest struct {
	ctx context.Context
...
func (r ApiAddressBalancesRequest) Limit(limit int32) ApiAddressBalancesRequest {
	r.limit = &limit
	return r
}

// Offset
func (r ApiAddressBalancesRequest) Offset(offset int32) ApiAddressBalancesRequest {
	r.offset = &offset
	return r
}

func (r ApiAddressBalancesRequest) Execute() ([]ResponsesBalance, *http.Response, error) {
	return r.ApiService.AddressBalancesExecute(r)
}

/*
AddressBalances Get list of balances for address
...
Returns a paginated list of all token balances held by the given address, including native and IBC tokens. Results are ordered by currency name.
 ...
 @param hash Hash
 @return ApiAddressBalancesRequest
*/
func (a *AddressAPIService) AddressBalances(ctx context.Context, hash string) ApiAddressBalancesRequest {
	return ApiAddressBalancesRequest{
		ApiService: a,
		ctx: ctx,
		hash: hash,
...
//  @return []ResponsesBalance
func (a *AddressAPIService) AddressBalancesExecute(r ApiAddressBalancesRequest) ([]ResponsesBalance, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ResponsesBalance
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AddressAPIService.AddressBalances")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/address/{hash}/balances"
