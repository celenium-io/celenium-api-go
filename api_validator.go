...
// Count of requested entities
func (r ApiValidatorMessagesRequest) Limit(limit int32) ApiValidatorMessagesRequest {
	r.limit = &limit
	return r
}

// Offset
func (r ApiValidatorMessagesRequest) Offset(offset int32) ApiValidatorMessagesRequest {
	r.offset = &offset
	return r
}

// Sort order
func (r ApiValidatorMessagesRequest) Sort(sort string) ApiValidatorMessagesRequest {
	r.sort = &sort
	return r
}
...
func (r ApiValidatorMessagesRequest) Execute() ([]ResponsesMessage, *http.Response, error) {
	return r.ApiService.ValidatorMessagesExecute(r)
}
...
func (a *ValidatorAPIService) ValidatorMessagesExecute(r ApiValidatorMessagesRequest) ([]ResponsesMessage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ValidatorAPIService.ValidatorMessages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/validators/{id}/messages"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiValidatorMetricsRequest) Execute() (*ResponsesMetrics, *http.Response, error) {
	return r.ApiService.ValidatorMetricsExecute(r)
}
...
// Execute executes the request
//  @return ResponsesMetrics
func (a *ValidatorAPIService) ValidatorMetricsExecute(r ApiValidatorMetricsRequest) (*ResponsesMetrics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponsesMetrics
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ValidatorAPIService.ValidatorMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/validators/{id}/metrics"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiValidatorsMetricsRequest struct {
	ctx context.Context
	ApiService *ValidatorAPIService
	count *int32
}
...
func (r ApiValidatorsMetricsRequest) Count(count int32) ApiValidatorsMetricsRequest {
	r.count = &count
	return r
}

func (r ApiValidatorsMetricsRequest) Execute() (*ResponsesTopNMetrics, *http.Response, error) {
	return r.ApiService.ValidatorsMetricsExecute(r)
}
...
*/
func (a *ValidatorAPIService) ValidatorsMetrics(ctx context.Context) ApiValidatorsMetricsRequest {
	return ApiValidatorsMetricsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ResponsesTopNMetrics
func (a *ValidatorAPIService) ValidatorsMetricsExecute(r ApiValidatorsMetricsRequest) (*ResponsesTopNMetrics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponsesTopNMetrics
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ValidatorAPIService.ValidatorsMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/validators/metrics"
