...
[**StatsTvs**](StatsAPI.md#StatsTvs) | **Get** /stats/tvs | Get TVS of the network
[**StatsTvsSeries**](StatsAPI.md#StatsTvsSeries) | **Get** /stats/tvs/{timeframe} | Get histogram for network TVS
...
> int32 StatsTvs(ctx).Execute()

Get TVS of the network
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StatsAPI.StatsTvs(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StatsAPI.StatsTvs``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StatsTvs`: int32
	fmt.Fprintf(os.Stdout, "Response from `StatsAPI.StatsTvs`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStatsTvsRequest struct via the builder pattern
...
> []ResponsesSeriesItem StatsTvsSeries(ctx, timeframe).From(from).To(to).Execute()

Get histogram for network TVS
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.StatsAPI.StatsTvsSeries(context.Background(), timeframe).From(from).To(to).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `StatsAPI.StatsTvsSeries``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `StatsTvsSeries`: []ResponsesSeriesItem
	fmt.Fprintf(os.Stdout, "Response from `StatsAPI.StatsTvsSeries`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiStatsTvsSeriesRequest struct via the builder pattern
