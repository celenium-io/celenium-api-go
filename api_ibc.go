...
type ApiGetIbcRelayersRequest struct {
	ctx context.Context
	ApiService *IbcAPIService
}

func (r ApiGetIbcRelayersRequest) Execute() ([]ResponsesRelayer, *http.Response, error) {
	return r.ApiService.GetIbcRelayersExecute(r)
}
...
*/
func (a *IbcAPIService) GetIbcRelayers(ctx context.Context) ApiGetIbcRelayersRequest {
	return ApiGetIbcRelayersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ResponsesRelayer
func (a *IbcAPIService) GetIbcRelayersExecute(r ApiGetIbcRelayersRequest) ([]ResponsesRelayer, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ResponsesRelayer
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IbcAPIService.GetIbcRelayers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ibc/relayers"
...
func (r ApiGetIbcTransferRequest) Execute() (*ResponsesIbcTransfer, *http.Response, error) {
	return r.ApiService.GetIbcTransferExecute(r)
}
...
func (a *IbcAPIService) GetIbcTransferExecute(r ApiGetIbcTransferRequest) (*ResponsesIbcTransfer, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IbcAPIService.GetIbcTransfer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/ibc/transfer/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
func (r ApiGetIbcTransfersRequest) Hash(hash string) ApiGetIbcTransfersRequest {
	r.hash = &hash
	return r
}
