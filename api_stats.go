...
type ApiStatsTvsRequest struct {
	ctx context.Context
	ApiService *StatsAPIService
}

func (r ApiStatsTvsRequest) Execute() (int32, *http.Response, error) {
	return r.ApiService.StatsTvsExecute(r)
}

/*
StatsTvs Get TVS of the network

Get TVS of the network

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiStatsTvsRequest
*/
func (a *StatsAPIService) StatsTvs(ctx context.Context) ApiStatsTvsRequest {
	return ApiStatsTvsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return int32
func (a *StatsAPIService) StatsTvsExecute(r ApiStatsTvsRequest) (int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAPIService.StatsTvs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stats/tvs"
...
type ApiStatsTvsSeriesRequest struct {
	ctx context.Context
	ApiService *StatsAPIService
	timeframe string
	from *int32
...
// Time from in unix timestamp
func (r ApiStatsTvsSeriesRequest) From(from int32) ApiStatsTvsSeriesRequest {
	r.from = &from
	return r
}

// Time to in unix timestamp
func (r ApiStatsTvsSeriesRequest) To(to int32) ApiStatsTvsSeriesRequest {
	r.to = &to
	return r
}

func (r ApiStatsTvsSeriesRequest) Execute() ([]ResponsesSeriesItem, *http.Response, error) {
	return r.ApiService.StatsTvsSeriesExecute(r)
}

/*
StatsTvsSeries Get histogram for network TVS

Get histogram for network TVS by timeframe

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param timeframe Timeframe
 @return ApiStatsTvsSeriesRequest
*/
func (a *StatsAPIService) StatsTvsSeries(ctx context.Context, timeframe string) ApiStatsTvsSeriesRequest {
	return ApiStatsTvsSeriesRequest{
		ApiService: a,
		ctx: ctx,
		timeframe: timeframe,
...
// Execute executes the request
//  @return []ResponsesSeriesItem
func (a *StatsAPIService) StatsTvsSeriesExecute(r ApiStatsTvsSeriesRequest) ([]ResponsesSeriesItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatsAPIService.StatsTvsSeries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stats/tvs/{timeframe}"
	localVarPath = strings.Replace(localVarPath, "{"+"timeframe"+"}", url.PathEscape(parameterValueToString(r.timeframe, "timeframe")), -1)
